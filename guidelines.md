...
Os usuários do Adobe Experience Manager trabalham em ambientes extremamente competitivos, esforçando-se para criar experiências digitais para se destacar de seus concorrentes. Portanto, quando a Adobe inclui novas ferramentas avançadas no AEM, elas são complementadas por uma documentação precisa e clara para permitir que clientes tirem proveito do AEM e maximizem o retorno do investimento.
...
### A Adobe documenta casos de uso padrão.
...
A documentação do AEM abrange casos de uso padrão. Por esse motivo, não documentamos erros, seus efeitos e soluções.
...
Você pode relatar qualquer dúvida sobre o uso do AEM ou erros técnicos por meio do processo normal de suporte no [portal de suporte corporativo da Experience Cloud](https://experienceleague.adobe.com/pt-br?support-solution=General#support) ou por meio da [comunidade do Experience Manager](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/ct-p/adobe-experience-manager-community?profile.language=pt).
...
O produto sempre deve ser mencionado com o nome completo, **Adobe Experience Manager**, quando usado pela primeira vez em um artigo. Depois disso, pode-se usar o termo **AEM**.
