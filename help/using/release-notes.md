...
| URL de download | <ul><li>[Apache 2.4](#apache)</li><li>[Serviços de Informações da Internet Microsoft® (IIS)](#iis)</li></ul> |
| Compatibilidade | AEM 6.1 ou superior |

## Requisitos e pré-requisitos do sistema {#system-requirements-and-prerequisites}

Consulte [Plataformas compatíveis](https://experienceleague.adobe.com/en/docs/experience-manager-64/deploying/introduction/technical-requirements) para obter mais informações sobre requisitos e pré-requisitos.

A Adobe recomenda usar a versão mais recente do AEM Dispatcher para se beneficiar das funcionalidades mais recentes, das correções de erros mais recentes e do melhor desempenho possível.
...
* DISP-1013 - adicione o suporte ao openssl 3.0 para Linux®.
...
* DISP-998 que torna configurável o carregamento de urls personalizados na inicialização.
...
* DISP-749 - O Alpine Linux® Dispatcher trava com o nível de log de rastreamento.
...
* DISP-826 - Oferece suporte à rebusca de URIs com uma cadeia de caracteres de consulta
...
* DISP-742 - As solicitações bloqueadas podem vazar informações para recursos protegidos pelo auth checker
...
* DISP-730 - 404 ao tentar acessar o arquivo de cabeçalho no Dispatcher
...
* DISP-685 - Os binários Solaris™ SPARC® de 32 bits têm uma referência indefinida a __divdi3
...
* DISP-698 - O TTL do Dispatcher deve suportar diretivas s-maxage e privadas
...
* DISP-705 - Falha do Dispatcher devido a duplo espaço livre ou corrupção (`fasttop`)
...
| Plataforma | Arquitetura | Suporte a OpenSSL | Clique para baixar |
|---|---|---|---|
