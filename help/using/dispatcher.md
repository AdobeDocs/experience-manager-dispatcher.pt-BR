...
* As atualizações de conteúdo que afetam arquivos são removidas, mas não são substituídas imediatamente. Na próxima vez que um arquivo for solicitado, o Dispatcher buscará o novo arquivo da instância do AEM e o colocará no cache, substituindo o conteúdo antigo.
